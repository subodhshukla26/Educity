    ...
    <div className='about'>
      ...
      <div className='about-right'>
        ...
        <p>Embark on a transformative educational journey with our
            ...
            curriculum is designed to eempower students with the knowledge,
        ...
        <p>Whether you aspire to become a teacher, administrator, counsellor or 
            educational lleader our diverse range of programs offers the perfect 
